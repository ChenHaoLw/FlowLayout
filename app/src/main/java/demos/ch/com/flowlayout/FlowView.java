package demos.ch.com.flowlayout;
...
public class FlowView extends ViewGroup {
  ...
  @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    /**note: 原本写法先判断 Mode 都是Exactly的情况下不去测量childView,从而提高效率。
     *       针对onMeasure是可以的,但是onLayout中需要获取子控件width和height时
     *       还是得测量,所以此处统一测量了。
     *
     */

    //if (measureHeightMode == MeasureSpec.EXACTLY && measureWidthMode == MeasureSpec.EXACTLY) {
